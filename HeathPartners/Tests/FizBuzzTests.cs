...
namespace Tests
{
    ...
    public class FizBuzzTests
    {
        ...
        [TestMethod]
        public void Solve_ReturnsFizzBuzzWhenDivisibleBy3and5InRange()
        {
            //Arrange
            IFizzBuzzLogic logic = new FizzBuzzLogic();
            ...
            List<string> result = data.Select(a => Constants.FizzBuzz).ToList();
        ...
        [DataRow(19)]
        [DataRow(37)]
        public void Solve_ReturnsFizzBuzzWhenDivisibleBy3and5WithNumbersInRange(object input)
        {
            //Arrange
            IFizzBuzzLogic logic = new FizzBuzzLogic();
